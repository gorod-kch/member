...
function showResult(){
    ...
    if(result < 4) {
        ...
        $('.results__description').html('Да уж...Печально. Если ты житель Качканара, то тебе должно быть стыдно. На твоём фоне даже эмигранты из Средней Азии выглядят более эрудированными. Прости, друг, но ты не имеешь морального права называть себя качканарцем. По крайней мере пока.');
    } else if (result >=4 && result < 7) {
        $('.results__subheader').text('Средний уровень');
        $('.results__description').html('Ну, не сказать, что ты уж прям красавчик, однако некоторые вещи о Качканаре всё же знаешь (если, конечно, не тыкал наугад). <br>Рекомендуем пройти тест ещё раз и провести работу над ошибками. Законспектируй вопросы в которых допустил ошибки и повторяй каждый вечер перед сном. Следуя данной инструкции ты сможешь со временем повысить уровень своих знаний о родном городе.');
    } else if (result >= 7 && result < 10) {
        $('.results__subheader').text('Высокий уровень');
        $('.results__description').html('А ты не плох! Пусть ты и не ответил правильно на все вопросы, но твёрдую четвёрку всё же заработал. Не забывай, что хоть твой уровень и выше среднего, тебе по прежнему есть куда стремиться. Оттачивай свои знания о Качканаре, подписывайся на наш паблик и будь счастлив!');
    } else {
        $('.results__subheader').text('Уровень: мудрец');
        $('.results__description').html('Блеск. Ты правильно ответил на все вопросы. Далеко не каждый житель города может похвастаться таким достижением! Обязательно опубликуй результат теста на своей стене в "ВКонтакте" - пусть твои друзья знают насколько ты крут. <br>Без всяких шуток, ты по праву заслужил звание -"Настоящий Качканарец". Аплодируем стоя! Браво!');
    }
